                                ...
                                <div class="p-2 mt-4">
                                    <form action="{{'/'}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Enter username" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                                        </div>

                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="pass-reset" class="text-muted">Forgot password?</a>
                                            </div>
