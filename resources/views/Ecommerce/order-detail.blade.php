                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="apps-invoices-details.html" class="btn btn-primary btn-sm"><i class="ri-download-2-fill align-middle me-1"></i> Invoice</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <lord-icon src="https://cdn.lordicon.com/uetqnvvg.json" trigger="loop" colors="primary:#8c68cd,secondary:#4788ff" style="width:80px;height:80px"></lord-icon>
