...
<!-- Mirrored from themesbrand.com/velzon/html/galaxy/apps-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 02:08:24 GMT -->
<head>
                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                            <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                    <span class="badge badge-soft-secondary fs-13"><span class="cartitem-badge">7</span>
                                        items</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <a href="{{'product-detail'}}" class="text-reset">Branded
                                                        T-Shirts</a>
                                                </h6>
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <a href="{{'product-detail'}}" class="text-reset">Bentwood Chair</a>
                                                </h6>
                                                <p class="mb-0 fs-12 text-muted">
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <a href="{{'product-detail'}}" class="text-reset">
                                                        Borosil Paper Cup</a>
                                                </h6>
                                                <p class="mb-0 fs-12 text-muted">
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <a href="{{'product-detail'}}" class="text-reset">Gray
                                                        Styled T-Shirt</a>
                                                </h6>
                                                <p class="mb-0 fs-12 text-muted">
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <a href="{{'product-detail'}}" class="text-reset">Stillbird Helmet</a>
                                                </h6>
                                                <p class="mb-0 fs-12 text-muted">
...
<!-- Mirrored from themesbrand.com/velzon/html/galaxy/apps-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 02:08:27 GMT -->
</html>
